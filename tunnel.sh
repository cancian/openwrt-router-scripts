...
User_Name=cancian
Tunnel_ID=583968
Server_IPv4_Address=216.66.64.154
Client_IPv6_Address=2001:470:1f2a:19b::2/64
Routed_48=2001:470:1f2b:19b::/64
#2600:70ff:c87e::/48
Update_Key=steS98fW0r3Bz1YK
...
uci -q delete network.henet
uci -q delete network.6in4-henet

uci set network.wan6=wan6
uci set network.wan6=6in4
uci set network.wan6.peeraddr=$Server_IPv4_Address
uci set network.wan6.ip6addr=$Client_IPv6_Address
uci set network.wan6.ip6prefix=$Routed_48
uci set network.wan6.tunnelid=$Tunnel_ID
uci set network.wan6.username=$User_Name
uci set network.wan6.password=$Update_Key
uci set network.wan6.mtu=1480
uci set network.wan6.ttl=64
uci commit network
